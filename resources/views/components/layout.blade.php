                ...
                @auth
                    <x-dropdown>
                        ...
                        @can('admin')
                            ...
                            <x-dropdown-item href="/admin/posts/create" class="{{ request()->is('admin/posts/create') ? 'text-blue-500' : ''}}" :active="request()->is('admin/posts/create')">New post</x-dropdown-item>
                        @endcan
